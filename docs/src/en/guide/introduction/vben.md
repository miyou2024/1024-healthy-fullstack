...
::: info You are reading the documentation for [Vben Admin](https://github.com/miyou2024/1024-healthy-web.git) version `5.0`!
...
- [Vben Admin](https://github.com/miyou2024/1024-healthy-web.git) is still being actively updated. Contributions are welcome to help maintain and improve the project, aiming to create a better mid- to backend solution.
