...
- The icons in the project are mainly provided by the `@ittlr/icons` package. It is recommended to manage them within this package for unified management and maintenance.
