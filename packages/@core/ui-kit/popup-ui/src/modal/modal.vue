...
import {
  ...
  usePriorityValues,
  useSimpleLocale,
} from '@ittlr-core/composables';
import { Expand, Shrink } from '@ittlr-core/icons';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
import { ELEMENT_ID_MAIN_CONTENT } from '@ittlr-core/shared/constants';
import { globalShareState } from '@ittlr-core/shared/global-state';
import { cn } from '@ittlr-core/shared/utils';
