...
import type { AnyFunction } from '@ittlr/types';

import { computed, useTemplateRef, watch } from 'vue';

import { useHoverToggle } from '@ittlr/hooks';
import { LockKeyhole, LogOut } from '@ittlr/icons';
import { $t } from '@ittlr/locales';
import { preferences, usePreferences } from '@ittlr/preferences';
import { useLockStore } from '@ittlr/stores';
import { isWindowsOs } from '@ittlr/utils';

import { useVbenModal } from '@ittlr-core/popup-ui';
import {
  Badge,
  DropdownMenu,
  DropdownMenuContent,
