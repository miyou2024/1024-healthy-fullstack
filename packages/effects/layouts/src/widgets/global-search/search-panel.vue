...
import type { MenuRecordRaw } from '@ittlr/types';

import { nextTick, onMounted, ref, shallowRef, watch } from 'vue';
import { useRouter } from 'vue-router';

import { SearchX, X } from '@ittlr/icons';
import { $t } from '@ittlr/locales';
import { mapTree, traverseTreeValues, uniqueByField } from '@ittlr/utils';

import { VbenIcon, VbenScrollbar } from '@ittlr-core/shadcn-ui';
import { isHttpUrl } from '@ittlr-core/shared/utils';
