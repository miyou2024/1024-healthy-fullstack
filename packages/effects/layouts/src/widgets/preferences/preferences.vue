...
import { Settings } from '@ittlr/icons';
import { $t, loadLocaleMessages } from '@ittlr/locales';
import { preferences, updatePreferences } from '@ittlr/preferences';
import { capitalizeFirstLetter } from '@ittlr/utils';

import { useVbenDrawer } from '@ittlr-core/popup-ui';
import { VbenButton } from '@ittlr-core/shadcn-ui';
