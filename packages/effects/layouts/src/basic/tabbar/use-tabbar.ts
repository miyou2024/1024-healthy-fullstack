...
import type { TabDefinition } from '@ittlr/types';

import type { IContextMenuItem } from '@ittlr-core/tabs-ui';

import { computed, ref, watch } from 'vue';
import { useRoute, useRouter } from 'vue-router';

import { useContentMaximize, useTabs } from '@ittlr/hooks';
import {
  ArrowLeftToLine,
  ArrowRightLeft,
  ArrowRightToLine,
...
import { $t, useI18n } from '@ittlr/locales';
import { useAccessStore, useTabbarStore } from '@ittlr/stores';
import { filterTree } from '@ittlr/utils';
