...
const customConfig: Linter.Config[] = [
  ...
  {
    // @core/shared内部组件，不能引入@ittlr/* 或者 @ittlr-core/* 里面的包
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@ittlr/*', '@ittlr-core/*'],
              message:
                'The @ittlr-core/shared package cannot import the @vben package, please use the @core/shared package itself',
            },
          ],
        },
      ],
